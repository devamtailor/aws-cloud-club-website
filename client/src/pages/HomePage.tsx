    ...
    <main className="pb-16">
      <section className="hero-grid relative overflow-hidden px-4 pt-32 pb-24 lg:px-8">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 -left-40 h-80 w-80 rounded-full bg-linear-to-br from-orange-500/10 to-transparent blur-3xl"></div>
          <div className="absolute -bottom-20 right-0 h-96 w-96 rounded-full bg-linear-to-tl from-blue-500/5 to-transparent blur-3xl"></div>
        </div>
      ...
      >
        <div className="mb-12">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              onClick={() => navigate("/why-us")}
              className="hidden shrink-0 text-sm font-semibold text-orange-400 transition hover:text-orange-300 md:block"
            >
              Learn more →
            </button>
          </div>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-20 lg:px-8">
        <GlassCard className="relative overflow-hidden py-16 px-8 lg:py-20">
          ...
          <div className="absolute top-0 right-0 h-64 w-64 -mr-32 -mt-32 rounded-full bg-linear-to-br from-orange-500/10 to-transparent blur-3xl"></div>
